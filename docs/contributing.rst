...
If the ``evmone`` library is not found, tests that use it are skipped. These tests
are ``libsolididty/semanticTests``, ``libsolidity/GasCosts``, ``libsolidity/SolidityEndToEndTest``
part of the soltest suite.
